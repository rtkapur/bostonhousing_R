...
```{r, message = FALSE}
boston <- read_csv("C:\\Users\\ryant\\Documents\\HW\\R\\boston.csv") %>%
  clean_names()

zips <- read_csv("C:\\Users\\ryant\\Documents\\HW\\R\\zips.csv") %>%
  clean_names()
...
> Select 4 categorical variables and create bar charts to evaluate mean av_total among each of them.
...
# Model Analysis for Executive Summary
